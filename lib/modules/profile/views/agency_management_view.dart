                          ...
                          DataCell(Row(
                            ...
                            children: [
                              ...
                              PopupMenuButton<String>(
                                ...
                                onSelected: (value) {
                                  final agencyId =
                                      agency['_id'] ?? agency['id'] ?? '';
                                  if (value == 'disable') {
                                    controller.disableAgency(
                                        agencyId, agency['name'] ?? 'Agency');
                                      ...
                                      AlertDialog(
                                        ...
                                        title: const Text('Delete Agency',
                                            style: TextStyle(
                                                ...
                                                fontWeight: FontWeight.bold)),
                                        content: Text(
                                            'Are you sure you want to permanently delete ${agency['name'] ?? 'this agency'}?\n\nThis action cannot be undone and will release all associated users.',
                                            style: const TextStyle(
                                        ...
                                        actions: [
                                          ...
                                          ElevatedButton(
                                            ...
                                            onPressed: () {
                                              ...
                                              controller.deleteAgency(agencyId,
                                                  agency['name'] ?? 'Agency');
                                            },
