    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          Obx(() => IconButton(
            icon: Icon(controller.isSpeakerEnabled.value ? Icons.volume_up : Icons.volume_down),
                  ...
                  children: [
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(seat.status.name, style: const TextStyle(fontSize: 10, color: Colors.grey)),
                              ],
                            ),
                          ),
                        );
                    ...
                    Obx(() => Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text('Notice: ${controller.currentRoom.value?.announcement ?? 'No notice'}'),
                          const SizedBox(height: 12),
                          Text('Rules: ${controller.currentRoom.value?.welcomeMessage ?? 'Be respectful'}'),
                          const SizedBox(height: 12),
                          Text('Tags: ${(controller.currentRoom.value?.tags ?? []).join(', ')}'),
                          const Divider(),
                          SwitchListTile(
